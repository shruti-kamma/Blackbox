  ...
  async function apply(jobId: string) {
    ...
    try {
      ...
      if (err instanceof ApiClientError && err.code === "ASSESSMENT_REQUIRED") {
        router.push("/nexo/candidate/assessment");
        return;
      }
        ...
        <div>
          ...
          {assessmentCompleted === false && (
            <div className="mb-6 flex items-center justify-between gap-4 rounded-md border border-primary/30 bg-primary/5 p-4">
              ...
              <Link
                href="/nexo/candidate/assessment"
              ...
              {applications && applications.length > 0 && (
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <Link href="/nexo/candidate/applications" className="text-sm font-medium text-primary">
                      View all →
                    </Link>
                  </div>
          ...
          <div className="mb-1 flex items-center justify-between gap-4 border-t border-border pt-8">
            ...
            <Link href="/nexo/candidate/resume" className="whitespace-nowrap text-sm font-medium text-primary">
              View resume →
            </Link>
          </div>
          ...
          {appliedCount > 0 && (
            <p className="mb-4 text-sm text-muted-foreground">
              ...
              <Link href="/nexo/candidate/applications" className="font-medium text-primary">
                My applications
              </Link>
              .
            </p>
