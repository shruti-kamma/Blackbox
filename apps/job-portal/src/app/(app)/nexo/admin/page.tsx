            ...
            {attentionCount === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {data.needsAttention.deadListings.map((j) => (
                  ...
                  >
                    <Link href={`/nexo/admin/employers/${j.organizationId}`} className="font-medium underline">
                      {j.organizationName}
                    </Link>
                    {"'s "}
                ...
                {data.needsAttention.zeroMatchCandidates.map((c) => (
                  <div
                    ...
                    className="rounded-md border border-danger bg-danger/10 p-3 text-sm text-foreground"
                  >
                    <Link href={`/nexo/admin/candidates/${c.id}`} className="font-medium underline">
                      {c.fullName}
                    </Link>{" "}
                ...
                {data.needsAttention.stalePendingAccommodations.map((a) => (
                  <div
                    ...
                    className="rounded-md border border-danger bg-danger/10 p-3 text-sm text-foreground"
                  >
                    <Link href={`/nexo/admin/employers/${a.organizationId}`} className="font-medium underline">
                      {a.organizationName}
                    </Link>{" "}
                ...
                {data.needsAttention.guaranteedInterviewSkips.map((s, i) => (
                  <div
                    ...
                    className="rounded-md border border-danger bg-danger/10 p-3 text-sm text-foreground"
                  >
                    <Link href={`/nexo/admin/employers/${s.organizationId}`} className="font-medium underline">
                      {s.organizationName}
                    </Link>{" "}
                ...
                {data.needsAttention.staleInProgressAssessments.map((a) => (
                  <div key={a.id} className="rounded-md border border-danger bg-danger/10 p-3 text-sm text-foreground">
                    <Link href={`/nexo/admin/candidates/${a.candidateId}`} className="font-medium underline">
                      {a.candidateName}
                    </Link>{" "}
