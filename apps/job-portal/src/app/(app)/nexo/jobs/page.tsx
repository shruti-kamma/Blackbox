...
// The original job-portal marketing page, now at /nexo/jobs. Not currently
// linked from anywhere in-app (the umbrella page's "Blackbox Jobs" card
// opens the portal-select modal instead) — kept for direct/typed navigation.
